...
unit    class Hypervisor::IBM::POWER::HMC::REST::ManagedSystems::ManagedSystem::LogicalPartitions::LogicalPartition::PartitionMemoryConfiguration:api<1>:auth<Mark Devine (mark@markdevine.com)>
...
has     Str                                         $.BarrierSynchronizationRegisterArrayCount      is conditional-initialization-attribute;
has     Str                                         $.CurrentBarrierSynchronizationRegisterArrays   is conditional-initialization-attribute;
has     Str                                         $.DesiredHugePageCount                          is conditional-initialization-attribute;
...
has     Str                                         $.MaximumHugePageCount                          is conditional-initialization-attribute;
has     Str                                         $.MaximumMemory                                 is conditional-initialization-attribute;
has     Str                                         $.MinimumHugePageCount                          is conditional-initialization-attribute;
...
method init () {
    ...
    $!BarrierSynchronizationRegisterArrayCount      = self.etl-text(:TAG<BarrierSynchronizationRegisterArrayCount>,     :$!xml, :optional)  if self.attribute-is-accessed(self.^name, 'BarrierSynchronizationRegisterArrayCount');
    $!CurrentBarrierSynchronizationRegisterArrays   = self.etl-text(:TAG<CurrentBarrierSynchronizationRegisterArrays>,  :$!xml, :optional)  if self.attribute-is-accessed(self.^name, 'CurrentBarrierSynchronizationRegisterArrays');
    $!DesiredHugePageCount                          = self.etl-text(:TAG<DesiredHugePageCount>,                         :$!xml)             if self.attribute-is-accessed(self.^name, 'DesiredHugePageCount');
    ...
    $!MaximumHugePageCount                          = self.etl-text(:TAG<MaximumHugePageCount>,                         :$!xml)             if self.attribute-is-accessed(self.^name, 'MaximumHugePageCount');
    $!MaximumMemory                                 = self.etl-text(:TAG<MaximumMemory>,                                :$!xml)             if self.attribute-is-accessed(self.^name, 'MaximumMemory');
    $!MinimumHugePageCount                          = self.etl-text(:TAG<MinimumHugePageCount>,                         :$!xml)             if self.attribute-is-accessed(self.^name, 'MinimumHugePageCount');
