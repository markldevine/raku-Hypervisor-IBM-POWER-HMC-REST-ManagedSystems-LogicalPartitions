...
has     Str                                         $.BarrierSynchronizationRegisterArrayCount;
has     Str                                         $.CurrentBarrierSynchronizationRegisterArrays;
has     Str                                         $.DesiredHugePageCount;
has     Str                                         $.DesiredMemory;
has     Str                                         $.ExpansionFactor;
has     Str                                         $.HardwarePageTableRatio;
has     Str                                         $.MaximumHugePageCount;
has     Str                                         $.MaximumMemory;
has     Str                                         $.MinimumHugePageCount;
...
method load () {
    ...
    $!BarrierSynchronizationRegisterArrayCount      = self.etl-text(:TAG<BarrierSynchronizationRegisterArrayCount>,     :$!xml, :optional);
    $!CurrentBarrierSynchronizationRegisterArrays   = self.etl-text(:TAG<CurrentBarrierSynchronizationRegisterArrays>,  :$!xml, :optional);
    $!DesiredHugePageCount                          = self.etl-text(:TAG<DesiredHugePageCount>,                         :$!xml);
    ...
    $!MaximumHugePageCount                          = self.etl-text(:TAG<MaximumHugePageCount>,                         :$!xml);
    $!MaximumMemory                                 = self.etl-text(:TAG<MaximumMemory>,                                :$!xml);
    $!MinimumHugePageCount                          = self.etl-text(:TAG<MinimumHugePageCount>,                         :$!xml);
