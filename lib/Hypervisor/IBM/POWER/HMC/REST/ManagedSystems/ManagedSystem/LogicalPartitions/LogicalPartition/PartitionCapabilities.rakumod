...
unit    class Hypervisor::IBM::POWER::HMC::REST::ManagedSystems::ManagedSystem::LogicalPartitions::LogicalPartition::PartitionCapabilities:api<1>:auth<Mark Devine (mark@markdevine.com)>
...
method init () {
    ...
    $!DynamicLogicalPartitionVIOSCapable                        = self.etl-text(:TAG<DynamicLogicalPartitionVIOSCapable>,                       :$!xml, :optional)  if self.attribute-is-accessed(self.^name, 'DynamicLogicalPartitionVIOSCapable');
